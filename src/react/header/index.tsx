...
export class ScheduleHeader extends React.Component {
  render() {
    ...
    <button className='fullscreen' style={{ position: 'absolute', right: '80px', height: '30px', top: '10px' }} onClick={() => document.body.requestFullscreen ? document.body.requestFullscreen() : document.body['webkitRequestFullscreen']()}>fullscreen: { document.fullscreenEnabled ? 'true' : 'false' }</button>
      </header>
    )
  }
}